...
// Source: github.com/Turalchik/bot/internal/app/repo (interfaces: EventRepo)
...
import (
	...
	payment "github.com/Turalchik/bot/internal/model/payment"
...
func (m *MockEventRepo) Add(arg0 []payment.InvoiceEvent) error {
	m.ctrl.T.Helper()
...
func (m *MockEventRepo) Lock(arg0 uint64) ([]payment.InvoiceEvent, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Lock", arg0)
	ret0, _ := ret[0].([]payment.InvoiceEvent)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
