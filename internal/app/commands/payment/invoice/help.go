...
func (invoiceCommander *DummyInvoiceCommander) Help(inputMsg *tgbotapi.Message) {
	command2Description := map[string]string{
		...
		"/list__payment__invoice":        "Получает список счетов с поддержкой постраничной навигации",
		"/delete__payment__invoice <ID>": "Удаляет счет по идентификатору и возвращает статус операции",
		"/edit__payment__invoice":        "Обновляет данные существующего счета",
		"/new__payment__invoice":         "Создает новый счет и возвращает его идентификатор",
	}
